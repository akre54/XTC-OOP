...
import xtc.oop.translate.FullName;
...
public class EWalk extends Visitor
{
	...
	public void visitSelectionExpression(GNode n)
	{
		...
		{
			fullName.append("."+(String)o);
		}
		else {
			dispatch((Node) o);
		}
		Object namePart = n.get(1);
	}
	...
	public void visitCallExpression(GNode n)
	{
		...
		{
			fullName.append((String)name);
		}
		//Now fully qualified name should be compiled in fullName object
		String sFName = fullName.returnName();
		//could use pattern mattching here
		if (sFName.equals("System.out.print")) {
			fullName = new FullName ("std:cout ");
		}
		if (sFName.equals("System.out.println")) {
			fullName = new FullName ("std:cout ");
		}
		...
		if (sFName.equals("System.out.println")) {
			fullName.append("std:endl;");
		}
		inCall = false;
		//Now must replace entire expressionstatement with this string and it's arguments
		n.remove(0);
		n.add(2,fullName);
	}
