...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    if (k1.getName().equals("Test")) {
      System.out.println("PASS k1.getName().equals(\"Test\")");
      success++;
    } else {
      System.out.println("FAIL k1.getName().equals(\"Test\")");
    }
    test++;

    // -----------------------------------------------------------------------

    if ("Test".equals(k1.getName())) {
    ...
    if (k1.toString().equals("class Test")) {
